...
#include "NexosWeaponBase.h"
#include "Effects/NexosImpactEffects.h"
#include "NexosWeapon_Instant.generated.h"
...
UCLASS(Abstract)
class ANexosWeapon_Instant : public ANexosWeaponBase
{
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = Effects)
		TSubclassOf<ANexosImpactEffects> ImpactTemplate;
