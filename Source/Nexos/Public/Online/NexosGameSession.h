...
#include "Online.h"
#include "NexosGameSession.generated.h"
...
UCLASS()
class NEXOS_API ANexosGameSession : public AGameSession
{
...
protected:
	...
	FNexosSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FNexosOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FNexosOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ANexosGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ANexosGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	...
	DECLARE_EVENT_OneParam(ANexosGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
