...
#include "NexosPlayerController.generated.h"

class ANexosHUD;


UCLASS(config = Game)
class NEXOS_API ANexosPlayerController : public APlayerController
{
...
// 	virtual void Emote(const FString& Msg);
	...
	void OnDeathMessage(class ANexosPlayerState* KillerPlayerState, class ANexosPlayerState* KilledPlayerState, const UDamageType* KillerDamageType);
	...
	// begin ANexosPlayerController-specific
	...
	/** Returns a pointer to the nexos game hud. May return NULL. */
	ANexosHUD* GetNexosHUD() const;
	...
	// end ANexosPlayerController-specific
...
protected:
	...
	/** nexos in-game menu */
	TSharedPtr<class FNexosInGameMenu> NexosInGameMenu;
