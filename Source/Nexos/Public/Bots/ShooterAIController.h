...
public:
	...
	void CheckAmmo(const class ANexosWeaponBase* CurrentWeapon);

	void SetEnemy(class APawn* InPawn);

	class ANexosPlayerCharacter* GetEnemy() const;
	...
	UFUNCTION(BlueprintCallable, Category = Behavior)
	bool FindClosestEnemyWithLOS(ANexosPlayerCharacter* ExcludeEnemy);
...
protected:
	...
	bool LOSTrace(ANexosPlayerCharacter* InEnemyChar) const;
